...
class _GuardHomeState extends State<GuardHome> {
  late GuardHomeViewmodel _viewmodel;

  @override
  void initState() {
    super.initState();
    _viewmodel = GuardHomeViewmodel();
    _viewmodel.init();
  }
                          ...
                          child: Row(
                            children: [
                              ...
                              _buildQuickActionButton(
                                ...
                                title: 'Tamu\n',
                                onTap: () =>
                                    context.pushNamed(GuardRoutes.guest.name!),
                              ),
                              _buildQuickActionButton(
                                      ...
                                      builder: (context) {
                                        return ListMenuBottomSheet(
                                          ...
                                          listWidget: [
                                            ...
                                            _buildQuickActionButton(
                                              image:
                                                  AppAssets.icPresensiKaryawan,
                                              title: 'Tamu\n',
                                              isBottomSheet: true,
                                              onTap: () => context.pushNamed(
                                                  GuardRoutes.guest.name!),
                                            ),
                                            _buildQuickActionButton(
                              ...
                              builder: (context, vm, _) {
                                ...
                                return Container(
                                  ...
                                  child: GridView(
                                    ...
                                    children: [
                                      _buildStatisticCard(
                                          vm!.totalPetugas, 'Total Petugas', 1),
                                      _buildStatisticCard(
                                          vm.totalAbsensi, 'Total Absensi', 2),
                                      _buildStatisticCard(vm.totalChecklist,
                                          'Total Rekap Checklist', 3),
                                      _buildStatisticCard(vm.totalBerita,
                                          'Total Berita Acara', 4),
                                    ],
                                  ),
                                );
                              },
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12.sp,
                  fontWeight:
                      isBottomSheet ? FontWeight.normal : FontWeight.bold,
